<?php
/**
 * @package	CMB2\Field_Horarios
 * @author 	scottsawyer
 * @copyright	Copyright (c) scottsawyer
 *
 * Plugin Name: CMB2 Field Type: Horarios
...
if ( ! class_exists( 'CMB2_Field_Horarios' ) ) {
  /**
   * Class CMB2_Field_Horarios
   */
  class CMB2_Field_Horarios {
    ...
    public function __construct() {
      add_action( 'cmb2_render_horarios', [$this, 'render_horarios'], 10, 5 );
      add_filter( 'cmb2_sanitize_horarios', [$this, 'maybe_save_split_values'], 12, 4 );
      add_filter( 'cmb2_sanitize_horarios', [$this, 'sanitize'], 10, 5 );
      add_filter( 'cmb2_types_esc_horarios', [$this, 'escape'], 10, 4 );
    }    
    ...
    //public static function class_name() { return __CLASS__; }
		 ...
		 */
    public static function horarios( $field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object ) {
	...
	$cmb2_field_horarios = new CMB2_Field_Horarios();
}
