"use strict";(self.webpackChunk=self.webpackChunk||[]).push([["map-places"],{"./js/map-places.js":function(e,a,t){t.r(a),t.d(a,{PlacesMap:function(){return s}});const s=(()=>{let s=ThemeSetup.currentID||0,c=document.getElementById("post-"+s),l=c.querySelector(".single-widget-area");return{init:()=>{if(console.log("Inicializando mapa de lugares",s),c){var e=c.querySelectorAll("[data-place-id]");{const a=`
