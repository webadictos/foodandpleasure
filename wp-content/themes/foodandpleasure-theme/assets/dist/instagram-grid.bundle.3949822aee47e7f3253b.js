"use strict";(self.webpackChunk=self.webpackChunk||[]).push([["instagram-grid"],{"./js/instagram-grid.js":function(e,t,a){a.r(t),a.d(t,{instagramGrid:function(){return r}});const r=(()=>{const n=void 0===ThemeSetup.social.igtoken?"":ThemeSetup.social.igtoken;let s="";const o=(e,t)=>{console.log(e),e.data.forEach(function(e){t.innerHTML=t.innerHTML+(e=>{let t="";return t=`
      <div class="scrolling-wrapper__item wa-instagram__item">
      <div class="scrolling-wrapper__thumbnail media-${e.media_type.toLowerCase()}">
