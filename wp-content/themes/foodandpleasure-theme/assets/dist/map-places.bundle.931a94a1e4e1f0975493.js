...
</div>`,s=document.createRange().createContextualFragment(t);d.prepend(s)}document.getElementById("map-widget-"+c);[...e].forEach(e=>{console.log(e.dataset.placeId)})}}}})()}}]);