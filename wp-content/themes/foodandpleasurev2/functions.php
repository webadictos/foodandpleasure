...
function wp_bootstrap_starter_scripts() {
  ...
  //  }
	...
	wp_enqueue_style( 'wp-bootstrap-starter-style', get_stylesheet_uri(),false,'10032021-1517' );
  /*  if(get_theme_mod( 'theme_option_setting' ) && get_theme_mod( 'theme_option_setting' ) !== 'default') {
    ...
    //wp_enqueue_style( 'acumin-font', get_template_directory_uri() . '/inc/assets/css/acumin.css', false, '2021-02-27' );

    wp_enqueue_style( 'foodandpleasure-main', get_template_directory_uri() . '/inc/assets/css/foodandpleasure.css', false, '11032021-1157' );
 ...
 */
    ...
    wp_enqueue_style( 'opensans', 'https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600;700;800&display=swap' );
    wp_enqueue_style( 'worksans', 'https://fonts.googleapis.com/css2?family=Work+Sans:wght@400;600;700&display=swap' );
...
//    wp_script_add_data( 'html5hiv', 'conditional', 'lt IE 9' ); 
   ...
   // }
    wp_enqueue_script('wp-bootstrap-starter-themejs', get_template_directory_uri() . '/inc/assets/js/theme-script.js', array(), '17082021-1458', true );

//    wp_enqueue_script( 'wp-bootstrap-starter-skip-link-focus-fix', get_template_directory_uri() . '/inc/assets/js/skip-link-focus-fix.min.js', array(), '20151215', true );
    wp_enqueue_script('food-js', get_template_directory_uri() . '/inc/assets/js/foodandpleasure.js', array(), '14102022-1105', true );
...
{
    if (false === ($ig_token = get_transient("wa_ig_token"))) {

        wp_safe_remote_get('https://graph.instagram.com/refresh_access_token?grant_type=ig_refresh_token&access_token=IGQVJVTEtXNHhjZAzFCa25kc3FxLU1QdmRfdVpId3J3NXV3a1FiSU9fY0owSkNfRmZAhUVYwbGtocVlrQ3lMSmQ1ck1tUzlWMk14dzk5NTRtZA0xtTDdlRElhQTRha2lsQk9ZAUXVvUnd6ZAVNvNGZAwRkFuOAZDZD');

        $ig_token = $GLOBALS['waIGToken'];

        set_transient('wa_ig_token', $ig_token, MONTH_IN_SECONDS); // 30 Minutos
    }
...
require get_template_directory() . '/inc/extras-food.php';
require get_template_directory() . '/inc/optimization.php';
require get_template_directory() . '/inc/loadmore.php';

require get_template_directory() . '/inc/widgets/mas-leido.php';
require get_template_directory() . '/inc/widgets/our-favorites.php';
